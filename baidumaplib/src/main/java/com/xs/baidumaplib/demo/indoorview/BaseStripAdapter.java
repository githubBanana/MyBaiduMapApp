 ...
 */
package com.xs.baidumaplib.demo.indoorview;
...
public class BaseStripAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = new com.xs.baidumaplib.demo.indoorview.StripItem(mContext);
            holder = new NoteViewHolder();
            holder.mFloorTextTV = ((com.xs.baidumaplib.demo.indoorview.StripItem) convertView).getmText();
